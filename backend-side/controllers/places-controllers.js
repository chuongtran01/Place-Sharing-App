...
const createPlace = async (req, res, next) => {
    // with async code, throw will not work correctly, so use next instead
...
const deletePlace = async (req, res, next) => {
    ...
    let place;
    try {
        place = await Place.findById(placeId).populate('creator'); // populate to interact with the other collection
    } catch (err) {
